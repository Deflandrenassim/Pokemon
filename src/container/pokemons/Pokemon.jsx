...
export function Pokemons() {
  ...
  const [copyPokemons, useCopyPokemons] = useState(pokemons);
  ...
  console.log(copyPokemons.length); 
    ...
    return (
      <>
        <div className="search-container">
          ...
          />
          <Button onClick={HandleSearchPokemon} size="S">
            {" "}
            Valider{" "}
          </Button>
          <Button onClick={HandleSearchResetPokemons} size="S">
            {" "}
            X{" "}
          </Button>
        </div>

        <div className="container-search-pokemon"></div>
